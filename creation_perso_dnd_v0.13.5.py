...
def update_comboboxes():
    ...
    for combobox, label_text in comboboxes:
        ...
        elif "outils de l'historique" in label_text.lower() and combobox.label_text == "Outils de l'historique":
            historique_selectionne = historique_combobox.get()
            if historique_selectionne:
                values = historiques[historique_selectionne].get('outils', [])
        elif "choix d'outils de l'historique" in label_text.lower() and combobox.label_text == "Choix d'outils de l'historique":
            historique_selectionne = historique_combobox.get()
            if historique_selectionne:
