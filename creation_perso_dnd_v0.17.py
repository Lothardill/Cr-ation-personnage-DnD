...
classe_combobox.bind("<<ComboboxSelected>>", lambda event: reset_sorts_selection())
race_combobox.bind("<<ComboboxSelected>>", lambda event: reset_sorts_selection())

# Initialiser l'affichage des sorts connus
reset_sorts_selection()
