...
races = {
    ...
    'Elfe': {'description': 'Les elfes sont graciles, énigmatiques et souvent intriguants.', 'bonus': {'Dextérité': 2, 'Sagesse': 1}},
...
def update_descriptions():
    ...
    for equip in equipements[historique_var.get()][equipement_var.get()]:
