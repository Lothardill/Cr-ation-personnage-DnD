...
def update_maitrise():
    ...
    # Fonction pour créer des menus déroulants
    ...
    if historique_selectionne:
        ...
        creer_menu_deroulant(outils_historiques, "Outils de l'historique", maitrise_frame, nombre=len(outils_historiques))
        if choix_outils_historiques:
            creer_menu_deroulant(choix_outils_historiques, "Outils de l'historique", maitrise_frame, nombre=1)

    # Langues de la race
    langues_parlees_race = races[race_selectionnee].get('langue_parlee_race', '').split(', ')
    creer_menu_deroulant(langues_parlees_race, "Langues de la race", maitrise_frame, nombre=1)
    creer_menu_deroulant(langues_standard + langues_exotiques, "Langues supplémentaires de la race", maitrise_frame, nombre=races[race_selectionnee].get('nombre_de_langue', 0))
    ...
    creer_menu_deroulant(langues_standard + langues_exotiques, "Langues de la classe", maitrise_frame, nombre=0)
